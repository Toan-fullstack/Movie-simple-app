...
const GalleryContextEx = createContext();
function GalleryProviderEx(props) {
...
function useGallery() {
  const context = useContext(GalleryContextEx);
  if (typeof context === "undefined")
    throw new Error("useGallery must be used within a AuthProvider");
  return context;
}
export { useGallery, GalleryProviderEx };
